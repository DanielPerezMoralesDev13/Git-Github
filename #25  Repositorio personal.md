...
4. **Opcional: Inicializa el repositorio con un archivo README:**
   *Puedes optar por inicializar el repositorio con un archivo `README.md`, que puede contener información sobre tu proyecto.*
