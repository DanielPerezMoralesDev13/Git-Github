...
- ***Pull Request:** Una solicitud de extracción (Pull Request o PR) es una forma de contribuir cambios a un repositorio. Permite proponer cambios y solicitar que se fusionen en el repositorio principal.*
...
- ***GitHub Pages:** GitHub Pages es un servicio que permite publicar sitios web directamente desde un repositorio en GitHub.*
